...
ollama.create(model='lyrics-class',
              ...
              "For each classification, put True the song belongs to that category. Otherwise, put False if it does not belong to that category." \
              "DO NOT guess the artist name or song title." \
              "Review and interpret each song's full lyrics as a critic — not just for keywords, but for narrative, tone, intent, and cultural context. DO NOT include any other text in the response." \
